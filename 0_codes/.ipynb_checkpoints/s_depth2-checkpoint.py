...
pipeline = StableDiffusionXLControlNetPipeline.from_single_file(
    "../3_models/dynavisionXLAllInOneStylized_releaseV0610Bakedvae.safetensors",
...
try:
    ...
    openpose_image = preprocess_depth("../1_datas/walkOpenpose.png")
...
prompt = "a cute cat, ((black background))"
# prompt = ""
# 재현성을 위한 시드 설정
...
pipeline_img2img.load_ip_adapter(
    "h94/IP-Adapter",
    subfolder="sdxl_models",
    weight_name="ip-adapter-plus_sdxl_vit-h.safetensors",
    image_encoder_folder="models/image_encoder",
)
pipeline_img2img.set_ip_adapter_scale(0.4)
