...
wandb.init(
    ...
    config={
        ...
        "lora_on": True,
        "size": [768, 768],
        "depth_image": "handmadeDepth2.png",
        "openpose_image": "handmadePose2.png",
...
def preprocess_openpose(image_path):
    ...
    return processed_image.resize((new_width, new_height))
...
# 입력 이미지 로드 및 전처리
input_image_path = "../1_datas/handmadeDepth.png"
openpose_image_path = "../1_datas/depth_input.png"

try:
    # openpose_image = preprocess_openpose(input_image_path)
    openpose_image = preprocess_depth("../1_datas/handmadePose.png")
...
prompt = "pixel, (a cute yellow cat), detail eyes, ((black background))"
# prompt = ""
# 재현성을 위한 시드 설정
...
try:
    latents = pipeline(
        ...
        controlnet_conditioning_scale=[0.8, 0.4], #0.7, 0.1 // 0.7 0.7 0.4
        control_guidance_end=0.7,
