...
from utils import get_unique_filename, get_pose_estimation, get_depth_estimation
...
def preprocess_depth(image_path):
    image = load_and_check_image(image_path)
    # image = get_depth_estimation(image_path)
    return image
...
# 작은 얼굴 전체 인퍼런스 이미지
ip_inference_image_path = "../1_datas/depth_input.png"
